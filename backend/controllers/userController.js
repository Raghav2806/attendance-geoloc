import { accessChecker, genQr, attendanceMarker } from "../services/userServices.js";
...
export async function attendanceMark(req, res, next) {
  try {
    await attendanceMarker(req.body);
